...
all: $(OUTPUTD)
$(OUTPUTD): src/main.o src/calc_asymptotic_variance.o src/dbslmm.o src/dptr.o
	$(CXX) src/main.o src/calc_asymptotic_variance.o src/dbslmm.o src/dptr.o -o $(OUTPUTD) $(CXXFLAG) -L $(ARMALIB)
